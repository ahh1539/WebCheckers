...
public class GetLeaveSpectateRoute implements Route {
    private static final Logger LOG = Logger.getLogger(GetLeaveSpectateRoute.class.getName());
    ...
    public GetLeaveSpectateRoute(final TemplateEngine templateEngine, GameCenter gameCenter) {
        ...
        //
        LOG.config("GetLeaveSpectateRoute is initialized.");
    }
    ...
    public Object handle(Request request, Response response) {
        LOG.finer("GetLeaveSpectateRoute is invoked.");
